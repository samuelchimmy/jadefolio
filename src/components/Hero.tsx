  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-between px-6 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center pt-16">
        <div className="inline-block text-xs text-muted-foreground border border-brand-purple/30 px-3 py-1 rounded-full animate-fade-in animate-pulse-glow mb-3" style={{ animationDelay: '0.2s' }}>
          AI-Native Full-Stack Developer | Vibe Coder
        </div>
        
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold animate-fade-in mb-4" style={{ animationDelay: '0.4s' }}>
      ...
      <div className="relative z-10 flex flex-col items-center text-center pb-12">
        <p className="text-sm text-muted-foreground max-w-lg mx-auto mb-4 animate-fade-in" style={{ animationDelay: '0.6s' }}>
