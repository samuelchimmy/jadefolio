  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        {/* Content Below Robot */}
        <div className="mt-32">
          <p className="text-sm sm:text-base text-muted-foreground max-w-md sm:max-w-lg md:max-w-2xl mx-auto mb-8 animate-fade-in text-center" style={{ animationDelay: '0.6s' }}>
